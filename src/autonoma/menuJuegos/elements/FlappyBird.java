...
public class FlappyBird extends SpriteContainer implements GraphicContainer {
    ...
    private void generarParObstaculos() {
        ...
        Obstaculo tuboArriba = new Obstaculo("autonoma/menuJuego/images/obstaculoDown.png", x, 0, alturaSuperior, 64, this);
        Obstaculo tuboAbajo = new Obstaculo("autonoma/menuJuego/images/osbtaculoUp.png", x, alturaSuperior + espacioEntreTubos, 512, 64, this);
